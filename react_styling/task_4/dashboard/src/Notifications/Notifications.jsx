...
export default function Notifications({ displayDrawer = true }) {
  if (!displayDrawer) {
    // Laisse un titre si ton app en attend un quand le drawer est fermé
    ...
    >
      ...
      <div className="notification-items p-4 max-[912px]:p-2">
        ...
        <ul
          className={[
            'ml-5 list-disc',
            // supprimer les puces en mobile/tablette
            'max-[912px]:list-none max-[912px]:ml-0',
          ].join(' ')}
        >
